...
async def search_papers(
    ...
    Args:
        ...
        year_start: 起始发表年份筛选（可选），格式为年份数字 YYYY，例如目前最新时间是 2026。
        year_end: 结束发表年份筛选（可选），格式为年份数字 YYYY，例如目前最新时间是 2026。
        sort: 排序方式。可选：
              - "relevance"（默认，按相关性）
    ...
    try:
        ...
        if year_start is not None or year_end is not None:
            # Semantic Scholar 支持年份范围格式 2020:2026 或单年 2026
